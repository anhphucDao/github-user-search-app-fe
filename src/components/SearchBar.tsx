    ...
    return (
        <div className="flex flex-row w-[20.44rem] h-[3.75rem] bg-github-white mt-[2.25rem] rounded-[0.94rem] items-center sm:w-[35.81rem] md:w-[45.63rem] md:h-[4.31rem] drop-shadow-lg min-h-[3.75rem]">
            ...
            <input
                ...
                type="text"
            ></input>
            <button className="w-[5.25rem] h-[2.88rem] bg-github-azure text-github-white rounded-[0.94rem] text-[0.88rem] sm:text-[1rem] leading-[1.56rem] font-bold mr-[0.5rem] sm:mr-[0.625rem] md:w-[6.63rem] md:h-[3.13rem] justify-self-center">
                Search
            </button>
        </div>
    );

...
export default function SearchBar() {
    ...
    return (
        <div
            className="flex flex-row w-[20.44rem] h-[3.75rem] bg-github-white mt-[2.25rem] rounded-[0.94rem] items-center sm:w-[35.81rem] md:w-[45.63rem] md:h-[4.31rem] drop-shadow-lg min-h-[3.75rem]"
            // ref={outerDivRef}
        >
            <SearchIcon
            ...
            <div className="grow whitespace-nowrap relative z-[-1]" ref={innerDivRef}>
                <input
                    ...
                    className={`text-[0.81rem] text-github-queenBlue placeholder-github-queenBlue outline-none sm:text-[1.13rem]  pl-[0.56rem] sm:pl-[1.5rem] box-border truncate ${
            ...
            <button
                className={`min-w-[5.25rem] h-[2.88rem] bg-github-azure text-github-white rounded-[0.94rem] text-[0.88rem] sm:text-[1rem] leading-[1.56rem] font-bold mr-[0.5rem] sm:mr-[0.625rem] md:w-[6.63rem] md:h-[3.13rem] justify-self-center hover:bg-[#60ABFF]`}
